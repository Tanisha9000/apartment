...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
       ...
       <span class="logo-mini"><b>A</b>partment Manager</span>
        <?php }else{?>
         <span class="logo-mini"><b>A</b>dmin</span>
        <?php }?> 
        <!-- logo for regular state and mobile devices -->
        <?php  if($loggeduser['role']=='apartmentmanager') {?>
        <span class="logo-lg"><b>Apartment Manager</b></span>
        <?php }else{?>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img  src="<?php echo $this->request->getAttribute("webroot").'img/upload_dir'.'/'.$user['image'];  ?>" class="img-circle" >
                    ...
                    <ul class="dropdown-menu">
                       ...
                       ?>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo $this->Url->build('/users/edit_profile/'.$loggeduser['id']); ?>"" class="btn btn-default btn-flat">Edit Profile</a>
                            </div>
