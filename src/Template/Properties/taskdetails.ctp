...
<?php }?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <td class="text-center">
                              <div class="btn-group " data-id="<?php echo $tas->id?>" >
                                  Yes <input type ="radio" id="<?php echo $tas->id?>" value="1" class="tog" name="radio[<?php echo $kk; ?>][change]">
...
<!--                            <button id="btn1<?php echo $tas->id?>"  type="button" class="btn btn-success btn-sm rad tt1" data-id="<?php echo $tas->id?>" pro-id="<?php echo $property[0]['id'];?>" >Yes</button>
                            <button id="btn2<?php echo $tas->id?>" type="button" class="btn btn-default btn-sm rad tt" data-id="<?php echo $tas->id?>" pro-id="<?php echo $property[0]['id'];?>">No</button>
                               -->
...
//                      ])
                        ?>
                            ...
                            <?php //echo $this->Form->buttonGroup([$this->Form->button('Yes'), $this->Form->button('No')]) ; ?>
<!--                        <div class="btn-group">
                        ...
                        <td>
                            <select  name="radio[<?php echo $kk; ?>][stageid]" class="form-control" placeholder="Name" id="stagename">
                                <?php foreach ($stage as $sta) { ?> 
                                    <option value="<?php echo $sta->id; ?>" ><?php echo $sta->name;  ?></option>
                          <?php } ?>
                           </select> 
                                    <input type="hidden" value="<?php echo $tas->id; ?>" name="radio[<?php echo $kk; ?>][taskid]">
                            
                        </td>
                             <?php    if(!empty($tas['add_tasks'])){?>
                        <td class="text-center hh" id="<?php echo $tas->id; ?>">
                        <a href="<?php echo $this->Url->build('/properties/moreinfo/'.$tas->id.'/'.$property[0]['id'].'/'.$tas['add_tasks'][0]['id']); ?>" class="btn btn-info btn-block btn-sm"><i class="fa fa-plus"></i> &nbsp; More Info</a>
                        <a href="history.html" class="btn btn-block btn-primary btn-sm"> History</a>
                        </td>
                        <?php }?>
                        </tr>
                        <?php
